...
#%% create the model's outer region
...
#app.mesh.assign_length_mesh(['shaft'], isinside=True, maxlength=0.005, maxel=None, meshop_name="shaft")
app.mesh.assign_length_mesh(['magnet_1', 'magnet_2'], isinside=True, maxlength=0.005, maxel=None, meshop_name="magnet")
#app.mesh.assign_length_mesh(['Region'], isinside=True, maxlength=0.01, maxel=None, meshop_name="region")
#%% setup settings
